...
function languageStrings() {
	...
	var languageVariables = {
		chartTitleText:				'Anime show ratings by year.',				// Chart title.
...
function plotSettings() {
	...
	var plotDisplayVariables = {
		...
		legendItemTopMargin:		5,			// Top margin (in pixels) for the items in the graph legend.
		legendItemBottomMargin:		5,			// Bottom margin (in pixels) for the items in the graph legend.
		legendBorderPadding:		12,			// Padding (in pixels) between the legend border and legend items.
		legendMarginPixels:			25,			// Margin (in pixels) between the graph legend and the chart.
		legendAlignment:			'center',	// Horizontal alignment for the legend in the graph area.
		legendVerticalAlignment:	'bottom',	// Vertical alignment for the legend in the graph area.
		legendWidth:				false,		// Legend width (in pixels). Set to 0 or false to allow automatic width detection.
		legendMaxHeight:			false,		// Legend height (in pixels). Set to 0 or false to allow automatic height detection.
		legendXOffset:				0,			// Horizontal offset for the legend position (in pixels).
		legendYOffset:				0,			// Vertical offset for the legend position (in pixels).
		exportButtonsAlignment:		'right',	// Horizontal alignment for the export buttons.
		exportButtonsVerticalAlign:	'top',		// Vertical alignment for the export buttons.
		exportImgButtonXOffset:		0,			// Horizontal offset (in pixels) for the image export button.
		exportPrtButtonXOffset:		0,			// Horizontal offset (in pixels) for the print export button.
		exportButtonsYOffset:		0			// Vertical offset (in pixels) for both export buttons.
	}
